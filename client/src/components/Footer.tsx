...
const CONTACT_EMAIL = "events@crewbasecollective.com";

const socials = [
  {
    label: "Discord",
    href: "https://discord.gg/3ptzZKgjud",
    icon: (
  ...
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/in/crewbase-collective/",
    icon: (
      <svg viewBox="0 0 24 24" className="h-4 w-4 fill-current" aria-hidden>
  ...
  {
    label: "Luma Calendar",
    href: "https://luma.com/calendar/cal-3A00RBKfF0vkoAd",
